...
export const BODY_FONT_OPTIONS = ["inter", "system", "poppins", "nunito", "ibm-plex-sans", "manrope", "dm-sans", "plus-jakarta-sans", "outfit", "sora", "space-grotesk", "orbitron", "audiowide", "rajdhani", "exo-2", "oxanium", "chakra-petch", "russo-one", "michroma", "pirata-one", "unifraktur-cook", "yatra-one", "kalam", "marck-script", "bungee", "bungee-shade", "monoton", "black-ops-one", "archivo-black"] as const;
