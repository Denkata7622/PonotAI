  ...
  return (
    <div className="flex h-full flex-col">
      <div className="flex items-center justify-between border-b border-[var(--border)] px-4 py-3">
        ...
        <button onClick={clearQueue} className="selectable-card rounded-[var(--radius-sm)] border border-transparent p-2" aria-label="Clear queue"><Trash2 className="h-4 w-4" /></button>
      </div>
      {queue.length === 0 ? (
