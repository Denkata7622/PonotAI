...
const AssistantNavIcon = ({ className }: { className?: string }) => <AssistantIcon className={className} size={20} variant="solid" animated={false} />;
